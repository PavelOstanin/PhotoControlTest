...
class AGImagesViewController: UIViewController, UIGestureRecognizerDelegate {
    ...
    var collectioView2: UICollectionView!
    
    var images : [UIImage] = []
    var imagesViewControllerDelegate : AGImagesViewControllerDelegate?
    ...
    override func viewDidLoad() {
        ...
        let gesture = UIPanGestureRecognizer.init(target: self, action: #selector(AGImagesViewController.panGesture))
    ...
    func configureCollectionViews() {
        ...
        collectioView.register(
            UINib(nibName: "AGImageCollectionViewCell", bundle: Bundle(for: AGImageCollectionViewCell.self)),
            forCellWithReuseIdentifier: "AGImageCollectionViewCell")
        
        //-----------------------------------
        
        let frame2 = CGRect(x: scrollView.frame.size.width,
                                 y: 0,
                                 width: UIScreen.main.bounds.width,
                                 height: view.frame.height - 40)
        ...
        collectioView2 = UICollectionView(frame: frame2, collectionViewLayout: layout2)
        collectioView2.backgroundColor = .clear
        scrollView.addSubview(collectioView2)

        collectioView2.delegate = self
        collectioView2.dataSource = self
        
        collectioView2.register(
            UINib(nibName: "AGImageCollectionViewCell", bundle: Bundle(for: AGImageCollectionViewCell.self)),
            forCellWithReuseIdentifier: "AGImageCollectionViewCell")
    ...
    override func viewDidLayoutSubviews() {
        ...
        collectioView2.frame = CGRect(x: scrollView.frame.size.width,
                                           y: 0,
                                           width: UIScreen.main.bounds.width,
                                           height: view.frame.height - 40)
    ...
    func removeBottomSheetView() {
        UIView.animate(withDuration: 0.3,
            ...
            self.imagesViewControllerDelegate?.imagesViewDidDisappear()
        })
    }
...
extension AGImagesViewController: UIScrollViewDelegate {
...
extension AGImagesViewController: UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        imagesViewControllerDelegate?.didSelectImage(image: images[indexPath.item])
    }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let identifier = "AGImageCollectionViewCell"
        let cell  = collectionView.dequeueReusableCell(withReuseIdentifier: identifier, for: indexPath) as! AGImageCollectionViewCell
